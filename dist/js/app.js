var app = angular.module('myComponents', ['ngAnimate', 'ui.bootstrap', 'ejangular', 'ngSanitize', 'ui.select']);
...
angular.module('myComponents').run(['$templateCache', function($templateCache) {$templateCache.put('app/Buttons/CreateButton/createButtonTemplate.html','<div ej-button id={{vm.id}} ng-click=vm.click() e-text=vm.buttonText><i class="fa fa-{{vm.icon}}"></i></div>]');
...
$templateCache.put('app/Panels/InfoPanel/infoPanelTemplate.html','<div class=bg-success>{{vm.info}}<ul class=on-page-nav></ul></div>');
